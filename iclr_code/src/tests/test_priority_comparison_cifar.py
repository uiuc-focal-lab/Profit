...
class TestPriorityComaparison(TestCase):
    def test_PGD_02_random(self):
        ...
        for topk in range(2, 21, 2):
            ...
            args = pt.TransferArgs(net=config.CIFAR_CONV_SMALL, domain=Domain.LIRPA_CROWN, approx=ap.Quantize(ap.QuantizationType.INT8), dataset=Dataset.CIFAR10, eps=2/255,
    ...
    def test_COLT_02_random(self):
        ...
        for topk in range(2, 21, 2):
            topk_priority=FeaturePriority.Random        
            topk_priority_norm = FeaturePriorityNorm.Linf
            args = pt.TransferArgs(net=config.CIFAR_CONV_COLT, domain=Domain.LIRPA_CROWN, approx=ap.Quantize(ap.QuantizationType.INT8), dataset=Dataset.CIFAR10, eps=2/255,
                                split=Split.RELU_ESIP_SCORE, count=200, pt_method=ProofTransferMethod.REUSE, 
                                timeout=30, output_dir='linear-search-results/', prop_index=None, ignore_properties=[], 
                                pruning_args=pruning_args, enable_sparsification=enable_sparsification, 
                                store_in_file=store_in_file, do_linear_search=False, topk=topk, topk_priority=topk_priority, 
    ...
    def test_CROWN_02_random(self):
        ...
        for topk in range(2, 21, 2):
            topk_priority=FeaturePriority.Random        
            topk_priority_norm = FeaturePriorityNorm.Linf
            args = pt.TransferArgs(net=config.CIFAR_CROWN_IBP, domain=Domain.LIRPA_CROWN, approx=ap.Quantize(ap.QuantizationType.INT8), dataset=Dataset.CIFAR10, eps=2/255,
                                split=Split.RELU_ESIP_SCORE, count=200, pt_method=ProofTransferMethod.REUSE, 
                                timeout=30, output_dir='linear-search-results/', prop_index=None, ignore_properties=[], 
                                pruning_args=pruning_args, enable_sparsification=enable_sparsification, 
                                store_in_file=store_in_file, do_linear_search=False, topk=topk, topk_priority=topk_priority, 
    ...
    def test_standard_02_random(self):
        ...
        for topk in range(2, 21, 2):
            topk_priority=FeaturePriority.Random        
            topk_priority_norm = FeaturePriorityNorm.Linf
            args = pt.TransferArgs(net=config.CIFAR_STANDARD_CONV, domain=Domain.LIRPA_CROWN, approx=ap.Quantize(ap.QuantizationType.INT8), dataset=Dataset.CIFAR10, eps=2/255,
                                split=Split.RELU_ESIP_SCORE, count=200, pt_method=ProofTransferMethod.REUSE, 
                                timeout=30, output_dir='linear-search-results/', prop_index=None, ignore_properties=[], 
                                pruning_args=pruning_args, enable_sparsification=enable_sparsification, 
                                store_in_file=store_in_file, do_linear_search=False, topk=topk, topk_priority=topk_priority, 
